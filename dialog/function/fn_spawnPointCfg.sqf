...
//-- FIX POUR KELLEY'S ISLAND --
// Force le jeu à utiliser la configuration "kelleysisland" peu importe le nom interne de la carte.
_world = "kelleysisland";

private _spawnCfg = missionConfigFile >> "CfgSpawnPoints" >> _world >> _side;
