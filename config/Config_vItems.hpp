// c:\Users\Shadow\Documents\Arma 3 - Other Profiles\Robert%20Fallange\missions\DreamLife.kelleysisland\config\Config_ShopStock.hpp
class CfgShopStock {
    class market { // Nom du magasin (doit correspondre à celui dans Config_vItems.hpp)
        items[] = {
            // itemClass, maxStock, lowStockThreshold (seuil d'alerte)
            {"waterBottle", 100, 20},
            {"apple", 80, 15},
            {"peach", 80, 15},
            {"tbacon", 50, 10},
    ...
    // Tu pourras ajouter d'autres magasins ici plus tard
    /*
    class rebel {
        items[] = {
            {"waterBottle", 50, 10}
