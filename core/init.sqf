...
// Cette boucle s'exécute en parallèle et sauvegarde les données du joueur toutes les 90 secondes.
// Cela n'affecte pas le cycle des paies et assure une meilleure protection contre la perte de données.
[] spawn {
    while {true} do {
        // Attend 90 secondes.
        sleep 90;

        // Ne sauvegarde que si le joueur est en vie pour éviter les problèmes.
