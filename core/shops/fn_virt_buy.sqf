...
hint "Vérification du stock et traitement de la transaction...";
// On envoie la requête au serveur pour qu'il gère la transaction et le stock.
[life_shop_type, _item, _value, player] remoteExecCall ["TON_fnc_handleShopPurchase", 2];
closeDialog 0;
